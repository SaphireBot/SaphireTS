...
export const DiscordErrorsMessage = {
    ClientInvalidOption: "System_Error.ClientInvalidOption",
    ClientInvalidProvidedShards: "System_Error.ClientInvalidProvidedShards",
    ClientMissingIntents: "System_Error.ClientMissingIntents",
    ClientNotReady: "System_Error.ClientNotReady",
    TokenInvalid: "System_Error.TokenInvalid",
    TokenMissing: "System_Error.TokenMissing",
    ApplicationCommandPermissionsTokenMissing: "System_Error.ApplicationCommandPermissionsTokenMissing",
    WSCloseRequested: "System_Error.WSCloseRequested",
    WSConnectionExists: "System_Error.WSConnectionExists",
    WSNotOpen: "System_Error.WSNotOpen",
    ManagerDestroyed: "System_Error.ManagerDestroyed",
    BitFieldInvalid: "System_Error.BitFieldInvalid",
    ShardingInvalid: "System_Error.ShardingInvalid",
    ShardingRequired: "System_Error.ShardingRequired",
    InvalidIntents: "System_Error.InvalidIntents",
    DisallowedIntents: "System_Error.DisallowedIntents",
    ShardingNoShards: "System_Error.ShardingNoShards",
    ShardingInProcess: "System_Error.ShardingInProcess",
    ShardingInvalidEvalBroadcast: "System_Error.ShardingInvalidEvalBroadcast",
    ShardingShardNotFound: "System_Error.ShardingShardNotFound",
    ShardingAlreadySpawned: "System_Error.ShardingAlreadySpawned",
    ShardingProcessExists: "System_Error.ShardingProcessExists",
    ShardingWorkerExists: "System_Error.ShardingWorkerExists",
    ShardingReadyTimeout: "System_Error.ShardingReadyTimeout",
    ShardingReadyDisconnected: "System_Error.ShardingReadyDisconnected",
    ShardingReadyDied: "System_Error.ShardingReadyDied",
    ShardingNoChildExists: "System_Error.ShardingNoChildExists",
    ShardingShardMiscalculation: "System_Error.ShardingShardMiscalculation",
    ColorRange: "System_Error.ColorRange",
    ColorConvert: "System_Error.ColorConvert",
    InviteOptionsMissingChannel: "System_Error.InviteOptionsMissingChannel",
    ButtonLabel: "System_Error.ButtonLabel",
    ButtonURL: "System_Error.ButtonURL",
    ButtonCustomId: "System_Error.ButtonCustomId",
    SelectMenuCustomId: "System_Error.SelectMenuCustomId",
    SelectMenuPlaceholder: "System_Error.SelectMenuPlaceholder",
    SelectOptionLabel: "System_Error.SelectOptionLabel",
    SelectOptionValue: "System_Error.SelectOptionValue",
    SelectOptionDescription: "System_Error.SelectOptionDescription",
    InteractionCollectorError: "System_Error.InteractionCollectorError",
    FileNotFound: "System_Error.FileNotFound",
    UserBannerNotFetched: "System_Error.UserBannerNotFetched",
    UserNoDMChannel: "System_Error.UserNoDMChannel",
    VoiceNotStageChannel: "System_Error.VoiceNotStageChannel",
    VoiceStateNotOwn: "System_Error.VoiceStateNotOwn",
    VoiceStateInvalidType: "System_Error.VoiceStateInvalidType",
    ReqResourceType: "System_Error.ReqResourceType",
    ImageFormat: "System_Error.ImageFormat",
    ImageSize: "System_Error.ImageSize",
    MessageBulkDeleteType: "System_Error.MessageBulkDeleteType",
    MessageNonceType: "System_Error.MessageNonceType",
    MessageContentType: "System_Error.MessageContentType",
    SplitMaxLen: "System_Error.SplitMaxLen",
    BanResolveId: "System_Error.BanResolveId",
    FetchBanResolveId: "System_Error.FetchBanResolveId",
    PruneDaysType: "System_Error.PruneDaysType",
    GuildChannelResolve: "System_Error.GuildChannelResolve",
    GuildVoiceChannelResolve: "System_Error.GuildVoiceChannelResolve",
    GuildChannelOrphan: "System_Error.GuildChannelOrphan",
    GuildChannelUnowned: "System_Error.GuildChannelUnowned",
    GuildOwned: "System_Error.GuildOwned",
    GuildMembersTimeout: "System_Error.GuildMembersTimeout",
    GuildUncachedMe: "System_Error.GuildUncachedMe",
    ChannelNotCached: "System_Error.ChannelNotCached",
    StageChannelResolve: "System_Error.StageChannelResolve",
    GuildScheduledEventResolve: "System_Error.GuildScheduledEventResolve",
    FetchOwnerId: "System_Error.FetchOwnerId",
    InvalidType: "System_Error.InvalidType",
    InvalidElement: "System_Error.InvalidElement",
    MessageThreadParent: "System_Error.MessageThreadParent",
    MessageExistingThread: "System_Error.MessageExistingThread",
    ThreadInvitableType: "System_Error.ThreadInvitableType",
    WebhookMessage: "System_Error.WebhookMessage",
    WebhookTokenUnavailable: "System_Error.WebhookTokenUnavailable",
    WebhookURLInvalid: "System_Error.WebhookURLInvalid",
    WebhookApplication: "System_Error.WebhookApplication",
    MessageReferenceMissing: "System_Error.MessageReferenceMissing",
    EmojiType: "System_Error.EmojiType",
    EmojiManaged: "System_Error.EmojiManaged",
    MissingManageGuildExpressionsPermission: "System_Error.MissingManageGuildExpressionsPermission",
    MissingManageEmojisAndStickersPermission: "System_Error.MissingManageEmojisAndStickersPermission",
    NotGuildSticker: "System_Error.NotGuildSticker",
    ReactionResolveUser: "System_Error.ReactionResolveUser",
    VanityURL: "System_Error.VanityURL",
    InviteResolveCode: "System_Error.InviteResolveCode",
    InviteNotFound: "System_Error.InviteNotFound",
    DeleteGroupDMChannel: "System_Error.DeleteGroupDMChannel",
    FetchGroupDMChannel: "System_Error.FetchGroupDMChannel",
    MemberFetchNonceLength: "System_Error.MemberFetchNonceLength",
    GlobalCommandPermissions: "System_Error.GlobalCommandPermissions",
    GuildUncachedEntityResolve: "System_Error.GuildUncachedEntityResolve",
    InteractionAlreadyReplied: "System_Error.InteractionAlreadyReplied",
    InteractionNotReplied: "System_Error.InteractionNotReplied",
    InteractionEphemeralReplied: "System_Error.InteractionEphemeralReplied",
    CommandInteractionOptionNotFound: "System_Error.CommandInteractionOptionNotFound",
    CommandInteractionOptionType: "System_Error.CommandInteractionOptionType",
    CommandInteractionOptionEmpty: "System_Error.CommandInteractionOptionEmpty",
    CommandInteractionOptionNoSubcommand: "System_Error.CommandInteractionOptionNoSubcommand",
    CommandInteractionOptionNoSubcommandGroup: "System_Error.CommandInteractionOptionNoSubcommandGroup",
    CommandInteractionOptionInvalidChannelType: "System_Error.CommandInteractionOptionInvalidChannelType",
    AutocompleteInteractionOptionNoFocusedOption: "System_Error.AutocompleteInteractionOptionNoFocusedOption",
    ModalSubmitInteractionFieldNotFound: "System_Error.ModalSubmitInteractionFieldNotFound",
    ModalSubmitInteractionFieldType: "System_Error.ModalSubmitInteractionFieldType",
    InvalidMissingScopes: "System_Error.InvalidMissingScopes",
    InvalidScopesWithPermissions: "System_Error.InvalidScopesWithPermissions",
    NotImplemented: "System_Error.NotImplemented",
    SweepFilterReturn: "System_Error.SweepFilterReturn",
    GuildForumMessageRequired: "System_Error.GuildForumMessageRequired",
};
...
export const TwitchLanguages = {
    ...
    "cr": "Cree",
    "cs": "Tcheco",
    "cu": "Eslavo eclesiástico; Antigo eslavo eclesiástico; Eslavo eclesiástico antigo búlgaro",
    "cv": "Chuvash",
    "cy": "Galês",
    "da": "Dinamarquês",
    "de": "Alemão",
    ...
    "hy": "Armênio",
    "hz": "Herero",
    "ia": "Interlingua (Associação Internacional de Língua Auxiliar)",
    "id": "Indonésio",
    ...
    "rm": "Romanche",
    "rn": "Rundi",
    "ro": "Romeno; Moldavo; Moldávio",
    "ru": "Russo",
    "rw": "Quiniaruanda; Kinyarwanda",
    "sa": "Sânscrito",
    "sc": "Sardo",
    "sd": "Sindi",
    "se": "Sami do Norte",
