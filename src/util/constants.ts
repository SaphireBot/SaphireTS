...
export const DiscordErrorsMessage = {
    ClientInvalidOption: "System_Error_ClientInvalidOption",
    ClientInvalidProvidedShards: "System_Error_ClientInvalidProvidedShards",
    ClientMissingIntents: "System_Error_ClientMissingIntents",
    ClientNotReady: "System_Error_ClientNotReady",
    TokenInvalid: "System_Error_TokenInvalid",
    TokenMissing: "System_Error_TokenMissing",
    ApplicationCommandPermissionsTokenMissing: "System_Error_ApplicationCommandPermissionsTokenMissing",
    WSCloseRequested: "System_Error_WSCloseRequested",
    WSConnectionExists: "System_Error_WSConnectionExists",
    WSNotOpen: "System_Error_WSNotOpen",
    ManagerDestroyed: "System_Error_ManagerDestroyed",
    BitFieldInvalid: "System_Error_BitFieldInvalid",
    ShardingInvalid: "System_Error_ShardingInvalid",
    ShardingRequired: "System_Error_ShardingRequired",
    InvalidIntents: "System_Error_InvalidIntents",
    DisallowedIntents: "System_Error_DisallowedIntents",
    ShardingNoShards: "System_Error_ShardingNoShards",
    ShardingInProcess: "System_Error_ShardingInProcess",
    ShardingInvalidEvalBroadcast: "System_Error_ShardingInvalidEvalBroadcast",
    ShardingShardNotFound: "System_Error_ShardingShardNotFound",
    ShardingAlreadySpawned: "System_Error_ShardingAlreadySpawned",
    ShardingProcessExists: "System_Error_ShardingProcessExists",
    ShardingWorkerExists: "System_Error_ShardingWorkerExists",
    ShardingReadyTimeout: "System_Error_ShardingReadyTimeout",
    ShardingReadyDisconnected: "System_Error_ShardingReadyDisconnected",
    ShardingReadyDied: "System_Error_ShardingReadyDied",
    ShardingNoChildExists: "System_Error_ShardingNoChildExists",
    ShardingShardMiscalculation: "System_Error_ShardingShardMiscalculation",
    ColorRange: "System_Error_ColorRange",
    ColorConvert: "System_Error_ColorConvert",
    InviteOptionsMissingChannel: "System_Error_InviteOptionsMissingChannel",
    ButtonLabel: "System_Error_ButtonLabel",
    ButtonURL: "System_Error_ButtonURL",
    ButtonCustomId: "System_Error_ButtonCustomId",
    SelectMenuCustomId: "System_Error_SelectMenuCustomId",
    SelectMenuPlaceholder: "System_Error_SelectMenuPlaceholder",
    SelectOptionLabel: "System_Error_SelectOptionLabel",
    SelectOptionValue: "System_Error_SelectOptionValue",
    SelectOptionDescription: "System_Error_SelectOptionDescription",
    InteractionCollectorError: "System_Error_InteractionCollectorError",
    FileNotFound: "System_Error_FileNotFound",
    UserBannerNotFetched: "System_Error_UserBannerNotFetched",
    UserNoDMChannel: "System_Error_UserNoDMChannel",
    VoiceNotStageChannel: "System_Error_VoiceNotStageChannel",
    VoiceStateNotOwn: "System_Error_VoiceStateNotOwn",
    VoiceStateInvalidType: "System_Error_VoiceStateInvalidType",
    ReqResourceType: "System_Error_ReqResourceType",
    ImageFormat: "System_Error_ImageFormat",
    ImageSize: "System_Error_ImageSize",
    MessageBulkDeleteType: "System_Error_MessageBulkDeleteType",
    MessageNonceType: "System_Error_MessageNonceType",
    MessageContentType: "System_Error_MessageContentType",
    SplitMaxLen: "System_Error_SplitMaxLen",
    BanResolveId: "System_Error_BanResolveId",
    FetchBanResolveId: "System_Error_FetchBanResolveId",
    PruneDaysType: "System_Error_PruneDaysType",
    GuildChannelResolve: "System_Error_GuildChannelResolve",
    GuildVoiceChannelResolve: "System_Error_GuildVoiceChannelResolve",
    GuildChannelOrphan: "System_Error_GuildChannelOrphan",
    GuildChannelUnowned: "System_Error_GuildChannelUnowned",
    GuildOwned: "System_Error_GuildOwned",
    GuildMembersTimeout: "System_Error_GuildMembersTimeout",
    GuildUncachedMe: "System_Error_GuildUncachedMe",
    ChannelNotCached: "System_Error_ChannelNotCached",
    StageChannelResolve: "System_Error_StageChannelResolve",
    GuildScheduledEventResolve: "System_Error_GuildScheduledEventResolve",
    FetchOwnerId: "System_Error_FetchOwnerId",
    InvalidType: "System_Error_InvalidType",
    InvalidElement: "System_Error_InvalidElement",
    MessageThreadParent: "System_Error_MessageThreadParent",
    MessageExistingThread: "System_Error_MessageExistingThread",
    ThreadInvitableType: "System_Error_ThreadInvitableType",
    WebhookMessage: "System_Error_WebhookMessage",
    WebhookTokenUnavailable: "System_Error_WebhookTokenUnavailable",
    WebhookURLInvalid: "System_Error_WebhookURLInvalid",
    WebhookApplication: "System_Error_WebhookApplication",
    MessageReferenceMissing: "System_Error_MessageReferenceMissing",
    EmojiType: "System_Error_EmojiType",
    EmojiManaged: "System_Error_EmojiManaged",
    MissingManageGuildExpressionsPermission: "System_Error_MissingManageGuildExpressionsPermission",
    MissingManageEmojisAndStickersPermission: "System_Error_MissingManageEmojisAndStickersPermission",
    NotGuildSticker: "System_Error_NotGuildSticker",
    ReactionResolveUser: "System_Error_ReactionResolveUser",
    VanityURL: "System_Error_VanityURL",
    InviteResolveCode: "System_Error_InviteResolveCode",
    InviteNotFound: "System_Error_InviteNotFound",
    DeleteGroupDMChannel: "System_Error_DeleteGroupDMChannel",
    FetchGroupDMChannel: "System_Error_FetchGroupDMChannel",
    MemberFetchNonceLength: "System_Error_MemberFetchNonceLength",
    GlobalCommandPermissions: "System_Error_GlobalCommandPermissions",
    GuildUncachedEntityResolve: "System_Error_GuildUncachedEntityResolve",
    InteractionAlreadyReplied: "System_Error_InteractionAlreadyReplied",
    InteractionNotReplied: "System_Error_InteractionNotReplied",
    InteractionEphemeralReplied: "System_Error_InteractionEphemeralReplied",
    CommandInteractionOptionNotFound: "System_Error_CommandInteractionOptionNotFound",
    CommandInteractionOptionType: "System_Error_CommandInteractionOptionType",
    CommandInteractionOptionEmpty: "System_Error_CommandInteractionOptionEmpty",
    CommandInteractionOptionNoSubcommand: "System_Error_CommandInteractionOptionNoSubcommand",
    CommandInteractionOptionNoSubcommandGroup: "System_Error_CommandInteractionOptionNoSubcommandGroup",
    CommandInteractionOptionInvalidChannelType: "System_Error_CommandInteractionOptionInvalidChannelType",
    AutocompleteInteractionOptionNoFocusedOption: "System_Error_AutocompleteInteractionOptionNoFocusedOption",
    ModalSubmitInteractionFieldNotFound: "System_Error_ModalSubmitInteractionFieldNotFound",
    ModalSubmitInteractionFieldType: "System_Error_ModalSubmitInteractionFieldType",
    InvalidMissingScopes: "System_Error_InvalidMissingScopes",
    InvalidScopesWithPermissions: "System_Error_InvalidScopesWithPermissions",
    NotImplemented: "System_Error_NotImplemented",
    SweepFilterReturn: "System_Error_SweepFilterReturn",
    GuildForumMessageRequired: "System_Error_GuildForumMessageRequired",
};
