...
export default async function embedWelcomeAtual(interaction: StringSelectMenuInteraction<"cached">) {
  ...
  const embed = new EmbedBuilder(data?.WelcomeNotification?.body?.embed || {}).data;
